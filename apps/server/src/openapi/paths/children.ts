...
export const CHILDREN_ROUTES: RouteDoc[] = [
  ...
  },
  {
    ...
    operation: {
      ...
      description: [
        ...
        "",
        "All three windows are calendar periods in the deployment's `APP_TIMEZONE`; `week` starts Monday.",
        "",
  ...
  },
  {
    ...
    operation: {
      ...
      description: [
        "Removes the profile and everything belonging to it (FR-PROF-07) — progress, quiz responses, rewards and streaks all cascade.",
        "",
