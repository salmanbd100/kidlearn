/**
 * See the note at the top of `shared/middleware/require-parent.test.ts`: there is no
 * test database yet, so `config/prisma.js` is stubbed and `auth.api.getSession` is
...
const { hashPin } = await import("../../shared/utils/pin.js");
