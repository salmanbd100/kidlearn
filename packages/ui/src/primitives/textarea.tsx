 ...
 *
 * Height comes from `rows`, not a size variant, so the two variants set padding
 * and type scale only. `min-h-11` keeps even a one-row textarea on the 44px
 * parent minimum (design.md §7).
 */
