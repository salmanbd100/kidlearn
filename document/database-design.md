...
- **Session additional field** (`activeChildProfileId`) lives on the better-auth `Session`, not on our models — the server stays the single source of truth (FR-AUTH-06). `pinVerifiedUntil` sat beside it until the parental PIN was removed on 2026-09-09.
